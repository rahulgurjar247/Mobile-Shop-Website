...
const TrendingProduct = () => {
  ...
  return (
    <div className="mt-10 w-2/3 mx-auto flex flex-col gap-4  ">
      ...
      <div
        className="w-full  mt-5 flex flex-wrap gap-7  transition-transform duration-300 ease-out "
        // style={{transform:`translateX(-${(currentIndex*270)}px)`}}
      >
        {data.slice(0, 6).map((item, _) => {
          return (
            <div
